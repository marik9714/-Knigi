...
namespace WindowsFormsApplication4
{
    public partial class Form1 : Form
    {
        ...
        //Как саму базу посмотреть?
        private void Form1_Load(object sender, EventArgs e)
        {
            string con;
            SqlConnection con1 = new SqlConnection(@"Data Source=DESKTOP-E8GUR0D;Initial Catalog=Магазин2;Integrated Security=True");//вот путь  такой указал 
            //OleDbDataAdapter dan = new OleDbDataAdapter("select *from Сотрудники", con1);
            //OleDbConnection connect = new OleDbConnection(con1);
            connect.Open();
